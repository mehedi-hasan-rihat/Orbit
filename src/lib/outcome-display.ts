...
export const OUTCOME_DISPLAY: Record<InterviewOutcome, { label: string; className: string }> = {
  ...
  REJECTED: { label: "Rejected", className: "bg-rose-100 text-rose-700 dark:bg-rose-900/50 dark:text-rose-300" },
  CANCELLED: { label: "Cancelled", className: "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400" },
  WITHDRAWN: { label: "Withdrawn", className: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300" },
